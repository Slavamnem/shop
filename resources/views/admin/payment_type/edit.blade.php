...
@section('content')
    <div class="container-fluid  dashboard-content">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-5">
            ...
            <form method="POST" action="{{ route("admin-payment-type-update", ['id' => $paymentType->id]) }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input id="inputText3" name="name" type="text" class="form-control" value="{{ $paymentType->name }}">
                                    </div>
                                </div>
                            </div>
