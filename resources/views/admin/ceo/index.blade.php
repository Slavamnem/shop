        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">CEO</h2>
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-9">
                                ...
                                <p>Панель управления для CEO-продвижения</p>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3">
                                {{--<a href="{{ route("admin-ceo-create") }}">--}}
...
@section("custom-js")
{{--    <script src="{{ asset("public/admin/assets/js/ceo/index.js") }}"></script>--}}
@endsection