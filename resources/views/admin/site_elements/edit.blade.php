...
@section('content')
    <div class="container-fluid  dashboard-content">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-5">
            ...
            <form method="POST" action="{{ route("admin-site-elements-update", ['id' => $siteElement->id]) }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input id="element-key" name="key" type="text" class="form-control" value="{{ $siteElement->key }}">
                                    </div>
                                    @if($errors->has("key"))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="value-block">
                                            ...
                                            @else
                                                <input id="inputText3" name="value" type="text" class="form-control" value="{{ $siteElement->value }}">
                                            @endif
                                        </div>
                                    </div>
                                    @if($errors->has("value"))
